...
#compile
/Users/giovanni.pozzobon/Documents/GitHub/llvm-mos-sdk/bin/mos-neo6502-clang++ -Os  main.cpp file.cpp graphic.cpp console.cpp util.cpp screen.cpp shape.cpp grid.cpp -o jtetris.neo
